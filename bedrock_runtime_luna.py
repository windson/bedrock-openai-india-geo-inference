#!/usr/bin/env python3
"""Invoke GPT-5.6 Luna through Amazon Bedrock Runtime India Geo."""
...
MODEL_ID = "in.openai.gpt-5.6-luna"


def invoke(prompt: str, max_tokens: int) -> dict:
    """Invoke Luna through its India Geo inference profile."""
    client = boto3.client(
        "bedrock-runtime",
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Invoke Luna with inference processed only in India."
    )
